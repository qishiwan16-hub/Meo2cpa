...
import (
	...
	codexauth "github.com/router-for-me/Meo2cpa/v6/internal/auth/codex"
	"github.com/router-for-me/Meo2cpa/v6/internal/config"
	"github.com/router-for-me/Meo2cpa/v6/internal/misc"
	"github.com/router-for-me/Meo2cpa/v6/internal/runtime/executor/helps"
...
func (e *CodexExecutor) cacheHelper(ctx context.Context, from sdktranslator.Format, url string, req cliproxyexecutor.Request, rawJSON []byte) (*http.Request, error) {
	...
	if from == "claude" {
		...
		if apiKey := strings.TrimSpace(helps.APIKeyFromContext(ctx)); apiKey != "" {
			cache.ID = uuid.NewSHA1(uuid.NameSpaceOID, []byte("meo2cpa:codex:prompt-cache:"+apiKey)).String()
		}
	}
